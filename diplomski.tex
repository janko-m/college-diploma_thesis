...
% TODO: Objasni bolje što je dokument
...
% TODO: Zašto obične baze podataka nisu dovoljne? (http://www.postgresql.org/docs/9.4/static/textsearch-intro.html)
% TODO: Full-text search & structured search (search engine treba imati oboje)
% TODO: Sortiranje
...
% TODO: + Distribuiranost (sharding, replike, nodeovi, clustering), to MORA biti objašnjeno (da li da to u zaključku?)
...
% TODO: Razmisli o strukturi naslova: Preprocesiranje, Analiza, Spremanje
% TODO: stop-riječi i korjenizacija zahtijevaju riječnik
...
% TODO: Proširivanje indeksa sinonimima znači da za *svaku* riječ dodajemo *svaki* sinonim u indeks.
...
% TODO: Paginacija je sporija što je veći page, tako da ne treba biti puno pageva (http://www.elasticsearch.org/guide/en/elasticsearch/guide/current/pagination.html)
...
% TODO: I duljina polja ima ulogu u rangiranju. Ako je polje kraće (title), onda je pronađena riječ veći deal nego ako je dulje (body).
...
% TODO: Spomeni da svaki (?) softver sadrži built-in riječnike i/ili da može importati Snowball
% TODO: "pretraživanje" => "pretraživanje teksta" (da se zna što je baza, a što full-text search)
% TODO: document naspram relational baza (http://www.elasticsearch.org/guide/en/elasticsearch/guide/current/_indexing_employee_documents.html)
% TODO: reći i za ostale softvere da li se sami brinu za distribuiranost
